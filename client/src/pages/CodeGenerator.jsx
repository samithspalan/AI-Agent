    ...
    <div className={`min-h-screen ${bg} pt-32 pb-20 px-6 transition-colors duration-300 relative overflow-hidden`}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
               <select
                    ...
                    className={`px-5 py-2.5 rounded-xl border outline-none font-bold text-xs uppercase tracking-widest transition-all ${
                ...
                <button
                    ...
                    className={`flex items-center gap-3 px-8 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider transition-all ${
                        description.trim() 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch h-[650px]">
            ...
            {/* Right Column: Output */}
            <div className={`relative flex flex-col border rounded-[2.5rem] overflow-hidden backdrop-blur-md transition-all shadow-2xl ${
                generatedCode ? 'border-blue-500/30' : cardBg
            }`}>
               <div className={`px-8 py-4 border-b flex items-center justify-between ${isDark ? 'bg-white/5 border-white/10' : 'bg-slate-50 border-slate-200'}`}>
                   <div className="flex items-center gap-3">
