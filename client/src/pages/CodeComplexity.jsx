      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="mb-10 text-center lg:text-left flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="flex items-center justify-center gap-3">
                ...
                <button
                   ...
                   className={`flex items-center gap-2 px-8 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider transition-all ${
                     inputCode.trim() 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch h-[650px]">
            ...
            <div className={`relative flex flex-col border rounded-[2.5rem] overflow-hidden backdrop-blur-md transition-all shadow-2xl ${
                analysis ? 'border-emerald-500/30' : cardBg
            }`}>
                <div className={`flex items-center justify-between px-8 py-4 border-b ${isDark ? 'bg-white/5 border-white/10' : 'bg-slate-50 border-slate-200'}`}>
                    <div className="flex items-center gap-3">
                        {analysis ? (
